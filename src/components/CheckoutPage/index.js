...
const CheckoutPage = () =>{
    ...
    const {user, cardNumber, expiryDate, securityCode} = useSelector(store=>store.bill.cardDetails);
    const serviceFees = 1.08;
    const deliveryFees = 0.00;
    const orderProcessingFees = 2.00;
    ...
    const handleUpdateQuantityAction = () =>{
        ...
        <div className="checkout_container">
            <div className="booked_show_details_container">
                ...
                <div className="booked_show_details">
                    ...
                    <div className="qty_cta_container" onClick={handleUpdateQuantityAction}>
            ...
            <div className="checkout_summary">
                ...
                <div className="total_bill_container">
                    ...
                    <button onClick={handlePlaceOrderBtn} className="place_order_btn">
                         Place Order
                    </button>
